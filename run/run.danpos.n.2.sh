################################################
#File Name: run.danpos.n.2.sh
#Author: LiTing
#Mail: liting@stu.pku.edu.cn
#Created Time: Fri 25 Feb 2022 07:42:44 PM CST
################################################
...
################################################
#File Name: ./run.danpos.o.2.sh
#Author: LiTing
#Mail: liting@stu.pku.edu.cn
#Created Time: Fri 25 Feb 2022 07:22:31 PM CST
################################################
...
[ -d /home/user/data/lit/project/6mA/feature/danpos/normed/method_2 ] || mkdir -p /home/user/data/lit/project/6mA/feature/danpos/normed/method_2
[ -d log/danpos/normed/method_2 ] || mkdir -p log/danpos/normed/method_2
output_dir=/home/user/data/lit/project/6mA/feature/danpos/normed/method_2
log_dir=log/danpos/normed/method_2
...
for sample in $(for i in `seq 1 2`;do echo PC10_LY_MCC-M$i;done);do
    sort -k1,1 -k2,2n /home/user/data/lit/project/6mA/feature/danpos/normed/method_1/${sample}.nucleosome.bed | bedtools merge -d 50 -c 1 -o count -i - | \
...
# 2022-02-25
# [ -d log/danpos/normed/method_2 ] || mkdir -p log/danpos/normed/method_2
# nohup bash run.danpos.n.2.sh >>log/danpos/normed/method_2/run.log 2>&1 &
