...
OUTPUT_DIR=/home/user/data2/lit/DATA/project/6mA/reproduce/output/6mASCOPE/Algae/
BINNED_BED_DIR=/home/user/data2/lit/project/6mA/reproduce/output/feature/iNPS/C.reinhardtii
IPD_OUT=/home/user/data2/lit/DATA/project/6mA/reproduce/output/6mASCOPE/Algae.Ipd.out
TMP_DIR=/home/user/data2/lit/DATA/project/6mA/reproduce/output/6mASCOPE/Algae/tmp
...
<<'!'
time (
less binned_bed.lst | grep -e '[1-5]$' |    \
while read bin;do
...
while read bin;do
    ...
    $PREDICT_SCRIPT $bin.ipd.out.A $bin >> $OUTPUT_DIR/binned.level.merge.txt 
done
wait )
!
...
# nohup bash /home/user/data2/lit/project/6mA/reproduce/bin/6mASCOPE.binned_level.sh > /home/user/data2/lit/project/6mA/reproduce/log/6mASCOPE.binned_level.log 2>&1 &