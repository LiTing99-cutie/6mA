...
###  feature analysis ###
    ...
    [ -d /home/user/data/lit/project/6mA/feature/danpos/original/method_1 ] || mkdir -p /home/user/data/lit/project/6mA/feature/danpos/original/method_1
    [ -d log/danpos/original/method_1 ] || mkdir -p log/danpos/original/method_1
    output_dir=/home/user/data/lit/project/6mA/feature/danpos/original/method_1
    log_dir=log/danpos/original/method_1
    ...
    for sample in $(for i in `seq 1 2`;do echo PC10_LY_MCC-M$i;done);do
        ...
        less danpos/original/${sample}/pooled/nucleosome_dyad.bed3 | \
...
# 2022-02-25
# [ -d log/danpos/original/method_1 ] || mkdir -p log/danpos/original/method_1
# nohup bash run.danpos.o.1.sh > log/danpos/original/method_1/run.log 2>&1 &